-- Expand 2026-07-28 novedades: empresa-first agent dashboard, lote chips, assignments list default, Agendados resize.
-- Idempotent upsert (keeps prior Jul 28 items; updates calls-trend wording to active days).
