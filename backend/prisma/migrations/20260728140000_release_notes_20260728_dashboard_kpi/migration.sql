-- Expand 2026-07-28 novedades: Dashboard KPI UX (tooltips, links, tasa modal, volver).
-- Idempotent upsert (keeps prior Ctrl+K agents highlight from 20260728120000).
